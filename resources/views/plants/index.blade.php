    ...
    <div class="container">
        ...
        <form method="GET" action="{{ route('plants.index') }}" class="filter-bar">
            ...
            <select name="sunlight">
                ...
                <option value="Low" {{ request('sunlight') == 'Low' ? 'selected' : '' }}>Low</option>
                <option value="Medium" {{ request('sunlight') == 'Medium' ? 'selected' : '' }}>Medium</option>
                <option value="High" {{ request('sunlight') == 'High' ? 'selected' : '' }}>High</option>
            </select>
