...
<body>
    ...
    <div class="container">
        ...
        <div class="search-bar">
            <input type="text" id="postSearch" placeholder="Search posts..." onkeyup="searchPosts()">
            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-delete" title="Delete this post"
                                onclick="confirmDelete('{{ $post->id }}', '{{ $post->title }}')">
                                <i class="fas fa-trash"></i> Delete
                            </button>
                            <button class="btn btn-view" title="View this post">
                                <a href="#"
    ...
    <div id="confirmModal" class="modal">
        <div class="modal-content">
            ...
            <p>Are you sure you want to delete the post "<span id="modalPostTitle"></span>"?</p>
    ...
    <script>
        function searchPosts() {
            let input = document.getElementById("postSearch").value.toLowerCase();
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (postIdToDelete) {
                ...
                fetch(`/posts/${postIdToDelete}`, {
                    ...
                    .then(data => {
                        if (data.success) {
                            deleteFeedback.textContent = 'Post deleted successfully!';
                            deleteFeedback.style.color = 'green';
                            let rowToDelete = document.querySelector(
                                `#postTable tbody tr[data-id="${postIdToDelete}"]`);
                            if (rowToDelete) {
                                rowToDelete.remove();
                            }
                        } else {
                            deleteFeedback.textContent = 'Error deleting post. Please try again.';
