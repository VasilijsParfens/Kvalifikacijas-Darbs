...
<body>
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr data-id="{{ $user->id }}">
                        ...
                        <td>
                            <button class="btn btn-edit" title="Edit this user"
                                onclick="openEditModal('{{ $user->id }}', '{{ $user->name }}', '{{ $user->email }}', '{{ $user->is_admin ? 'admin' : 'user' }}', '{{ $user->description }}', '{{ $user->profile_picture }}')">
        ...
        <div class="modal-content">
            ...
            <form id="editUserForm">
                ...
                <div class="image-upload">
                    <label for="editProfilePicture" class="btn btn-secondary">Upload Profile Picture</label>
    ...
    <script>
        ...
        function openEditModal(userId, userName, userEmail, userRole, userDescription, userProfilePicture) {
            document.getElementById('editName').value = userName;
            document.getElementById('editEmail').value = userEmail;
            document.getElementById('editRole').value = userRole;
            document.getElementById('editDescription').value = userDescription;
            document.getElementById('editProfilePreview').src = userProfilePicture;
