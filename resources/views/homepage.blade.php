    ...
    <div class="homepage-container">
        ...
        <section class="homepage-section" aria-labelledby="plants-section">
            <div class="section-header">
                ...
                <a href="{{ route('posts.lists.show', ['type' => 'plants']) }}" class="view-all-link">View All</a>
            </div>
                ...
                @foreach ($tips as $tip)
                    <div class="card tip-card">
                        <div class="card-content">
                            ...
                            <span class="date"><i class="fas fa-calendar-alt"></i>
                                {{ $tip->created_at->format('F d, Y') }}</span>
                        </div>
                        <div class="user-info">
            ...
            <div class="grid-container">
                @foreach ($showcases as $showcase)
                    <div class="card showcase-card">
                        <div class="card-content">
                            <img src="{{ $showcase->image ? asset('storage/' . $showcase->image) : asset('images/placeholder.jpg') }}"
        ...
        <section class="homepage-section" aria-labelledby="identifications-section">
            <div class="section-header">
                ...
                <a href="{{ route('posts.lists.show', ['type' => 'plant_identification']) }}" class="view-all-link">View All</a>
            </div>
            <div class="grid-container">
                @foreach ($identifications as $identification)
                    <div class="card identification-card">
                        <div class="card-content">
                            <img src="{{ asset('storage/' . $identification->image) }}" alt="Unknown Plant"
                                loading="lazy">
                            <p>{{ Str::limit($identification->content, 80) }}</p>
                            <span class="location"><i class="fas fa-map-marker-alt"></i>
                                {{ $identification->location ?? 'Unknown' }}</span>
                            <span class="date"><i class="fas fa-calendar-alt"></i>
