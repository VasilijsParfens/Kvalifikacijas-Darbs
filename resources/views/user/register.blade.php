    ...
    <div class="container">
        ...
        <form action="{{ route('register') }}" method="POST" id="registration-form">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Enter your email" value="{{ old('email') }}" required aria-describedby="email-help">
            ...
            <div class="form-group">
                ...
                <small id="password-error" style="display: none; color: red;">Password must be at least 8 characters long.</small>
            </div>
