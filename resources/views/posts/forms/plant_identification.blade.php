...
<body>
    <div class="container">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="type" value="plant_identification">  {{-- Ensures post is categorized correctly --}}
            ...
            <textarea id="content" name="content" rows="4" placeholder="Describe the plant's appearance, location, or any other relevant details..." required></textarea>
